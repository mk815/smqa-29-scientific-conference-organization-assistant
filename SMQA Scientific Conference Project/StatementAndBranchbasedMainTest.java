...
class StatementAndBranchbasedMainTest {
	...
	private static void deleteOrganizerEntry(String entryToDelete) {
		try {
            FileReader reader = new FileReader("organizer_credentials.txt");
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                if (!username.equals("organizer_credentials.txt")) {
            ...
            FileWriter writer = new FileWriter("organizer_credentials.txt");
	...
	@Test
	public void testOrganizerSignupNewEntry() {
        Organizer organizer = new Organizer();
        // Test case for save Organizer Credentials 
        organizer.saveOrganizerCredentials();
	}	
	@Test
